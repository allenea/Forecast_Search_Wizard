...
setup(
    ...
    name='Forecast_Search_Wizard',  # Required
    ...
    url='https://github.com/allenea/Forecast_Search_Wizard',  # Optional

    # This should be your name or the name of the organization which owns the
    # project.
    author='Eric Allen',  # Optional

    # This should be a valid email address corresponding to the author listed
    # above.
    author_email='allenea@udel.edu',  # Optional
    ...
    keywords='National Weather Service Keyword Search',  # Optional
